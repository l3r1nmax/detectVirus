...
for x in splitter:
    for z in criterion:
        for patu in pre:
            if patu == False:
                classifiers = [("DecissionTree: " + str(z) + " " + str(x), tree.DecisionTreeClassifier(criterion=z,splitter=x))]
            else:
                classifiers = [("DecissionTree: " + str(z) + " " + str(x) + " presorted", tree.DecisionTreeClassifier(criterion=z,splitter=x,presort=patu))]
